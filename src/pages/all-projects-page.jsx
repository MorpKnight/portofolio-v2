...
export default function AllProjectsPage() {
  ...
  const allProjects = t('projectsData', { returnObjects: true }) || [];
        ...
        {filteredProjects.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredProjects.map((project) => (
              <div key={project.id} className="bg-neutral-800 rounded-lg shadow-xl overflow-hidden flex flex-col transition-all duration-300 hover:shadow-violet-500/30 hover:scale-[1.02]">
          ...
          <p className="text-center text-violet-300 text-xl">{t('allProjectsPage.noProjects')}</p>
        )}
