      ...
      <div className="container mx-auto px-6">
        <div className="text-center">
          ...
          <div className="max-w-3xl mx-auto text-left md:text-center mb-12">
            ...
            <ul className="space-y-2 text-violet-200 inline-block text-left">
              <li className="flex items-center">
                <Server size={20} className="mr-3 text-violet-400 flex-shrink-0" />
                <span>{t('aboutMe.areaBackend')}</span>
              </li>
              <li className="flex items-center">
                <Cpu size={20} className="mr-3 text-violet-400 flex-shrink-0" />
                <span>{t('aboutMe.areaVHDL')}</span>
              </li>
              <li className="flex items-center">
                <Brain size={20} className="mr-3 text-violet-400 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <h3 className="text-2xl font-semibold text-violet-300 mb-8 text-center">
              {t('aboutMe.skillsSectionTitle', 'My Technical Skills')}
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
              {skillCategories.map((category) => (
                <div key={category.title} className="bg-neutral-800 p-4 rounded-lg shadow-md">
                  <h4 className="text-lg font-semibold text-violet-300 mb-3 flex items-center">
                    {category.icon}
                    {category.title}
                  </h4>
                  <ul className="space-y-1.5">
                    {category.skills.map((skill) => (
                      <li key={skill} className="text-violet-200/90 text-sm flex items-start">
                        <svg 
                          ...
                          className="text-violet-500 mr-2 mt-0.5 flex-shrink-0"
                        >
